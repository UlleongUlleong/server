...
//       'makgeolli',
//     ];
//     const alcoholInfo: { [key: string]: any } = {};
//     const category =
//       query.category !== undefined && query.category !== null
//         ? query.category
//         : 0;
//     alcoholInfo[alcoholCategories[category]] = await this.findAlcohol(query);
//     return alcoholInfo;
//   }

//   async findAlcohol(query) {
//     const { category, keyword, sort, offset, limit, cursor } = query;
...
//   async getAlcoholDetail(id: number, cursor?: number) {
...
//   }
//   async findAlcoholById(id: number): Promise<object> {
...
//       },
//     });
//     alcoholInfo.scoreAverage = parseFloat(alcoholInfo.scoreAverage.toFixed(1));
//     return alcoholInfo;
//   }
...
//   async getReview(alcoholId: number, cursor?: number): Promise<object> {
...
//   async markStatus(userId: number, alcoholId: number) {
