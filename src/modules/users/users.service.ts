...
export class UsersService {
  ...
  async updateUserProfile(userId: number, alcoholCategory:number[], moodCategory:number[]): Promise<ResponseProfileDto | null> {
  ...
  async createUserProfile(userId: number, alcoholCategory:number[], moodCategory:number[]): Promise<void> {
